...
- As variáveis são declaradas no corpo de uma **PROCEDURE**, ou **TRIGGER**, com a instrução **DECLARE**.\
...
# Modulo 27 PARTE 3 - **TRIGGER** (Gatilho), TRANSAÇÃO (**TRANSACTION**) e **ERRO**
...
- Função especifica para **PRINT** de **ERRO**.\
  - **RAISERROR**('*mensagem*',*numero_código*[*Nivel*, *Estado*])\
  Função que serve para escrever um **ERRO** e dar um **PRINT** dele na tela do usuário.\

## TRANSACTION (Transação)

### Teoria (LOG)

### Confirmar e eliminar LOG

## TRIGGER ERRO E RESTRIÇÃO DE REGRA DE NEGÓCIO
