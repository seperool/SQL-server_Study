...
#  Modulo 28 - Variáveis e **PROCEDURES**
...
- Sintaxe:\
**ALTER** (**PROCEDURE** | **PROC**) [*SCHEMA.*]*nome_Procedure* *parâmetro1* *tipo*, *parâmetro2* *tipo*, ...\
**AS**\
[Bloco de programação SQL]\
**GO**\

### **PROCEDURES** em tabelas - Entrada e Saída
