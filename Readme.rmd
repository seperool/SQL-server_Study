...
- São muito importantes para a performance e segurança.\
  ...
  - Facilitando assim dar permissões em certas tabelas a determinados usuários, permitindo ao usuário acesso a determinado **SCHEMA**.\
